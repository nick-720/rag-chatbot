...
class TestAIGeneratorGenerateResponse:
    ...
    def test_generate_response_returns_text_when_no_tool_use(self, ai_generator, mock_text_response):
        """
    ...
    def test_generate_response_passes_query_in_messages(self, ai_generator, mock_text_response):
        """
    ...
    def test_generate_response_detects_tool_use_stop_reason(self, ai_generator, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_generate_response_calls_tool_manager_with_correct_params(self, ai_generator, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_generate_response_handles_multiple_tool_calls(self, ai_generator, mock_multi_tool_response, mock_final_response):
        """
        Given: Claude returns multiple tool_use blocks
        When: generate_response() is called
        Then: All tools are executed
        """
        ai_generator.client.messages.create.side_effect = [mock_multi_tool_response, mock_final_response]
        mock_tool_manager = Mock()
    ...
    def test_generate_response_final_call_excludes_tools_after_max_rounds(self, ai_generator, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_generate_response_second_call_includes_tool_results(self, ai_generator, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_generate_response_preserves_tool_use_id_in_result(self, ai_generator, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_generate_response_includes_history_in_system(self, ai_generator, mock_text_response):
        """
    ...
    def test_generate_response_without_history_uses_base_system_prompt(self, ai_generator, mock_text_response):
        """
    ...
    def test_generate_response_passes_tools_when_provided(self, ai_generator, mock_text_response):
        """
    ...
    def test_generate_response_without_tools_omits_tool_params(self, ai_generator, mock_text_response):
        """
...
class TestAIGeneratorProcessToolChain:
    ...
    def test_process_tool_chain_returns_final_text(self, ai_generator_with_mock_client, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_process_tool_chain_preserves_original_messages(self, ai_generator_with_mock_client, mock_tool_use_response, mock_final_response):
        """
    ...
    def test_process_tool_chain_adds_assistant_response(self, ai_generator_with_mock_client, mock_tool_use_response, mock_final_response):
        """
...
class TestAIGeneratorConfiguration:
    ...
    def test_system_prompt_contains_key_instructions(self):
        ...
        assert "search tool" in AIGenerator.SYSTEM_PROMPT.lower() or "Search Tool" in AIGenerator.SYSTEM_PROMPT
...
class TestSequentialToolCalling:
    ...
    def test_two_sequential_tool_calls_makes_three_api_calls(
        self, ai_generator, mock_tool_use_response, mock_second_tool_use_response, mock_final_response
    ):
        """
